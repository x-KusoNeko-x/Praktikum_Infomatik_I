 ...
 *
 * @param pNext Zeiger auf das letzte Listenelement
 * @param pData Ein Objekt der Klasse Student
 * @param pNext Zeiger auf das naechste Listenelement
 */
ListenElement::ListenElement(ListenElement* pPrev, Student pData, ListenElement* pNext):
    prev(pPrev), data(pData), next(pNext)
{
}
 ...
 *
 * @param pPrev Zeiger auf das letzte Listenelement
 */
